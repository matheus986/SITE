...
Esta versão estática possui arquivos na raiz para permitir envio pelo navegador.
O projeto de desenvolvimento, com os originais organizados em `assets/` e os
scripts de manutenção, está preservado na pasta local SITE.
